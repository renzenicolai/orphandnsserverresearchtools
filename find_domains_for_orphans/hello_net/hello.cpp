...
int main() {
 ...
 QTextStream(stdout) << "[NET] FIND DOMAINS FOR ORPHANS" << endl;
 QString filename = "temp_NET/ALL";
 QFile file(filename);
...
void saveandclear( void ) {
 QString outputfile_name="temp/OUTPUT_NET_"+QString::number(outputcounter)+".txt";
